...
```html
<script src="https://cdn.jsdelivr.net/gh/reneoun/Open-Web-Components@v1.14.0/OWC/dist/components.js"></script>
```

[jsDelivr](https://www.jsdelivr.com/) serves the file directly from GitHub — no sign-up needed. The `@v1.14.0` pin means updates never break your page. **23 components + 1 utility** included.
